...
import { FaChevronDown, FaCode, FaJava, FaPython, FaLaptopCode } from 'react-icons/fa';
        ...
        <header className="tech-header">
            <div className="header-container">
                <Link to="/" className="logo-area">
                    ...
                    <span className="logo-text">Tech<span className="highlight">Insights</span></span>
                </Link>
                ...
                <nav className="main-nav">
                    ...
                    >
                        <span>More <FaChevronDown size={12} style={{ marginLeft: 5 }} /></span>
